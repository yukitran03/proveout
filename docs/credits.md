...
The front end's layout and visual system are informed by public hackathon-winning project
front ends. Any file containing borrowed markup or styling names its origin in a header
comment; where no origin is named, the file is original to this project.
